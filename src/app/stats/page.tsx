    ...
    <div className="container mx-auto p-4 py-8">
      <Card className="max-w-4xl mx-auto shadow-lg mb-8">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Correct answer percentage for each question in the last quiz
            session.
            {lastUpdated && (
        ...
        <CardContent>
          {isLoading ? (
            ...
            <p className="text-center text-muted-foreground py-8">
              No statistics available yet. Finish a quiz first.
            </p>
          ) : !error ? (
          ...
          {stats.length === 0 && error && !isLoading && (
            <p className="text-center text-destructive py-8">
              Error loading statistics. Retrying automatically...
            </p>
          )}
        </CardContent>
      </Card>
              ...
              <CardHeader>
                <CardTitle className="text-lg flex justify-between items-center">
                  ...
                  <span className="text-sm font-normal text-muted-foreground flex items-center">
                    <Users className="h-4 w-4 mr-1" /> {stat.totalAttempts}{" "}
                    Attempts
                  </span>
                </CardTitle>
              ...
              <CardContent>
                ...
                <div className="mb-3">
                  ...
                  <Progress
                    ...
                    aria-label={`${stat.correctPercentage.toFixed(1)}% Correct`}
                  />
                  <span className="text-xs text-muted-foreground">
                    {stat.correctCount} correct answers
                  </span>
                </div>
